 ...
 *
 * Diese Klasse verarbeitet aus FRISCO stammende XML-Dateien mit Zahlungsstroemen und
 * ueberfuehrt diese in das XML-Eingangsformat fuer TXS
 *
 *Beispiel fuer Eingang:
 *
 *<cashflow>
 *<vorlauf>
 *<inst>009</inst>
...
public class FriscoNeu extends DefaultHandler {
    ...
    /**
     * Liste fuer die Zahlungen pro Konto
    */
    ...
    */
    ...
    {   
        ...
        // alles fuer Liste DPP
        //String lvDPPDatei             ="";  
        //String lvDPPPfad              ="";  
        
        // alles fuer Liste DARLEHEN
        String lvDarlDatei            ="";  
        String lvDarlPfad             ="";  
        
        // alles fuer Liste Flug
        //String lvFlugDatei            ="";  
        //String lvFlugPfad             ="";  
        
        // alles fuer Liste Schiffe
        //String lvSchiffDatei          ="";  
        //String lvSchiffPfad           ="";  
        
        // alles fuer Liste OEPG
        String lvOEPGDatei            ="";  
        String lvOEPGPfad             ="";  
        
        // alles fuer Liste MAVIS
        //String lvMAVISDatei            ="";  
        //String lvMAVISPfad             ="";  
        
        // alles fuer Liste Darlehen WP
        //String lvDarlWPDatei            ="";  
        
        FileInputStream     lvStreamlogein    = null;
        FileOutputStream    lvStreamlogaus    = null;
             
        // pruefen, ob die .ini Datei uebergeben wurde
        ...
        // Maske fuer Eingangsdatei aus .ini lesen
        ...
        // Deckungspooling Eingabe oeffnen und in liste lesen
        try
        {
        ...
        {
            LOGGER.error("Konnte DPP " + lvDPPDatei + " nicht �ffnen");
        } */
        ...
        // Schiff Eingabe oeffnen und in liste lesen
        try
        {
        ...
        {
            LOGGER.error("Konnte Schiff " + lvSchiffDatei + " nicht �ffnen");
        }    
        */
        LOGGER.info("<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>");
        /*
        ...
        // Flugzeug Eingabe oeffnen und in liste lesen
        try
        {
        ...
        {
            LOGGER.error("Konnte Flug " + lvFlugDatei + " nicht oeffnen");
        }    
        */
        LOGGER.info("<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>");
        ...
        // OEPG Eingabe oeffnen und in liste lesen
        try
        {
        ...
        {
            LOGGER.error("Konnte OEPG " + lvOEPGDatei + " nicht �ffnen");
        }    
        ...
        // Darlehens Eingabe oeffnen und in liste lesen
        try
        {
        ...
        {
            LOGGER.error("Konnte DARL " + lvDarlDatei + " nicht �ffnen");
        }    
        ...
        // MAVIS Quellsystemdatei oeffnen und in liste lesen
        try
        {
        ...
        {
            LOGGER.error("Konnte MAVIS " + lvMAVISDatei + " nicht �ffnen");
        }  */
        //////////////////////////////////////////////////////////////////////////////////////////////
        ...
        // DarlWP Quellsystemdatei oeffnen und in liste lesen
        try
        {
        ...
        {
            LOGGER.error("Konnte DarlWP " + lvDarlWPDatei + " nicht �ffnen");
        } */
        //////////////////////////////////////////////////////////////////////////////////////////////
        ...
        // Es soll die sein, die den hoechsten daypointer hat und nicht in der Protokolldatei steht
       ...
       //   System.out.println("listing " + listing[n]); 
        ...
        {
          LOGGER.error("Konnte Protokolldatei " + lvEingabeverzeichnis + lvLogdateiname + " nicht �ffnen");
        }
        ...
        {
            LOGGER.error("bereits in Protokoll vorhanden, fuer erneute Verarbeitung hieraus loeschen");
            System.exit(1);
        }
        ...
        {
          LOGGER.error("Konnte logdatei " + lvEingabeverzeichnis + lvLogdateiname + " nicht �ffnen");
        }
    ...
    throws SAXException 
    {
        ...
        else if (qName.equalsIgnoreCase("stamm"))
        {
            ...
            // Schluessel bis zum naechsten Konto merken
            ...
            // Orginator zuweisen, anderen Orginator fuer DPP Konten
            // Weitehin ggf. Quellsystem fuer Aktiva 30/31 auf DPP
        ...
        {
            // unbeachtet sp�terer Zusammenfassungen wird alles schon in ein element gepackt
            ...
            // Jetzt das Herausrechnen der B�rgschaftsanteile
            // Der Prozenntsatz findet sich in der CashflowQuellsystem Daeti
            // Herumrechnen mit String/Bigdecinmal ist etwas umst�ndlich gel�st
            // cv_stamm_prod und cv_proz sind richtig gef�llt, weil pro Konto startElement() vor endElement
            // aufgerufen wird
         ...
         //     }
            ...
            // die Art wird sp�ter wieder gel�scht
            lvElement_cfdaten.setAttribute("art", attributes.getValue("art"));
            
            // Und an die Liste zum Konto h�ngen
            lvAblauflist.add((Element) lvElement_cfdaten);
            
            // Wenn es der (eine) Satz mit Ablaufart 17 (K�ndigung nach �489) ist, dann das Datum merken
    ...
    throws SAXException 
    {
        ...
        {
            // Kontoende erreicht
            // Zun�chst alle Elemente herausl�schen, die gr��er dem Datum einer eventuell
            ...
            // Einmal �ber alle Ablaufelemente um Tilgung und zins zum selben Datum zusammenzufassen
            ...
            for (int j=0; j<lvAblauflist.size(); j++)
            {
               ...
               if ( ("11".equals(lvAblaufelem.getAttributeValue("art"))) ||   // tilgung
                    ("12".equals(lvAblaufelem.getAttributeValue("art"))) ||   // au�erplanm��ige Tilgung
                    ...
                    ("17".equals(lvAblaufelem.getAttributeValue("art"))))     // RK zum K�ndigungstermin */
               {
                 lvTbetragbd = BigDecimal.valueOf(Double.parseDouble(lvAblaufelem.getAttributeValue("betrag")));
                 
                 // Keine Tilgungen fuer Passiva
               ...
               for (int k=j+1; k<lvAblauflist.size(); k++)
               {
                   ...
                   if (lvDatum1.equals(lvDatum2))
                   {
                       ...
                       // der rest der Liste r�ckt nach unten, daher z�hler wieder auf das n�chste
                       k--;
                   }
               } // for �ber die Ablaufelemente gleichen Datums
               ...
               // es gibt F�lle (Konsortialgesch�fte), bei denen hostseitig das konto zweimal geliefert wird, weil 
               // nicht alle cfs in eine "Kontoklammer" passen
               // daher m�ssen sich die cashflowids zum selben konto unterscheiden
               if (0 != cv_mehrzeilig)
               {
               ...
               // letzte cfdaten anh�ngen
               cvElement_fg.addContent(lvElement_cfdaten_last);
            } // for �ber die Ablaufelemente
            
            // letztes Konto in Ausgabe einh�ngen, aber nur, wenn das Quellsystem stimmt
     ...
     *  das ist meiner Meinung nach etwas ung�nstig gel�st...
     * @param buffer 
     * @param start 
     * @param length 
     */
