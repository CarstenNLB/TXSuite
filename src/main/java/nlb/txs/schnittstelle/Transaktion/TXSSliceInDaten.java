...
public class TXSSliceInDaten implements TXSTransaktion
{
    ...
    {
        pvLogger.info("Termingeld " + pvTermingeld.getKontonummer() + " - Ausplatzierungsmerkmal " + pvTermingeld
            .getAusplatzierungsmerkmal());
        ...
        // 3 -> Weitere Deckung
        this.ivDecktyp = "3";
        if (pvTermingeld.getAusplatzierungsmerkmal().endsWith("2") || pvTermingeld.getAusplatzierungsmerkmal().equals("O4"))
        {
            this.ivDecktyp = "2";
        }
