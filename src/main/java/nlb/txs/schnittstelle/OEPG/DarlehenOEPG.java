...
package nlb.txs.schnittstelle.OEPG;
...
public class DarlehenOEPG 
{
    ...
    { 
        if (!argv[argv.length - 1].endsWith(".ini"))
        {
            ...
            System.out.println("DarlehenOEPG <ini-Datei>");
            System.exit(0);
        }
        else
        {
            ...
            String lvLoggingXML = lvReader.getPropertyString("OEPG", "log4jconfig", "Fehler");
            ...
            new DarlehenVerarbeiten(DarlehenVerarbeiten.OEPG, lvReader);
        }
        System.exit(0);
    }
