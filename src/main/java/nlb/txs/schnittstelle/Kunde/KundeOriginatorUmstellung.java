...
public class KundeOriginatorUmstellung 
{
    /**
     * log4j-Logger
     */
    private static Logger LOGGER = Logger.getLogger("TXSKundeOriginatorUmstellungLogger"); 
	 ...
	 * @param pvOutputDatei
	 */
	public KundeOriginatorUmstellung(String pvInstitut, String pvImportVerzeichnis, String pvExportVerzeichnis, String pvKundennummernUmstellungDatei, String pvInputDatei, String pvOutputDatei)
	{
		...
		// Umstellung der Kunde-Originatoren
		umstellenKundeOriginator(pvImportVerzeichnis + "\\" + pvInputDatei, pvExportVerzeichnis + "\\" + pvOutputDatei);
	}
              ...
              else
              {
            	  if (lvZeile != null)
            	  {
            		  if (!lvZeile.startsWith("**** END OF FILE ****"))
            		  {
            			  ...
            			  LOGGER.info("KundennummernUmstellung-Daten: " + lvZeile);
	 ...
	 */
	private void umstellenKundeOriginator(String pvInputFilename, String pvOutputFilename)
	{
		LOGGER.info("Kunde-Originatoren umstellen...");
        ...
        try
        {
            ...
            {      	
              // Abschnitt 'kredkunde' suchen...
              if (lvZeile.contains("<txsi:kredkunde"))
              {
            	  String lvKundennummer = lvZeile.substring(lvZeile.indexOf("kdnr=\"") + 6,lvZeile.indexOf("kdnr=\"") + 6 + 10);

            	  // Alle Kunden auf Hauptkreditnehmer umstellen
            	  lvZeile = lvZeile.replace("rolle=\"1\"", "rolle=\"0\"");
            	  LOGGER.info("Rolle auf Hauptkreditnehmer(0) fuer " + lvKundennummer + " umgestellt.");
            	  
            	  //System.out.println("Kundennummer: " + lvKundennummer);
            	  for (KundennummernUmstellungDaten lvKundennummernUmstellungDaten : ivListeKundennummernUmstellungDaten.values())
            	  {
            		  if (lvKundennummernUmstellungDaten.getKdNrNLB().equals(lvKundennummer))
            		  {
            			  LOGGER.info("Originator fuer " + lvKundennummer + " auf NLB (25050000) umgestellt.");
            			  lvZeile = lvZeile.replace("org=\"29050000\"", "org=\"25050000\"");
            		  }
            	  }
              }
	...
	public static void main(String[] argv)
	{
        if (!argv[argv.length - 1].endsWith(".ini"))
        {
            ...
            System.out.println("KundeOriginatorUmstellung <ini-Datei>");
            System.exit(1);
        }
        else
        {
            ...
            if (lvReader != null)
            {
                String lvLoggingXML = lvReader.getPropertyString("KundeOriginatorUmstellung", "log4jconfig", "Fehler");
                ...
                String lvImportVerzeichnis = lvReader.getPropertyString("KundeOriginatorUmstellung", "ImportVerzeichnis", "Fehler");
                ...
                String lvExportVerzeichnis = lvReader.getPropertyString("KundeOriginatorUmstellung", "ExportVerzeichnis", "Fehler");
                ...
                String lvKundennummernUmstellungDatei =  lvReader.getPropertyString("KundeOriginatorUmstellung", "KundennummernUmstellungDatei", "Fehler");
                ...
                String lvInputDatei =  lvReader.getPropertyString("KundeOriginatorUmstellung", "InputDatei", "Fehler");
                ...
                String lvOutputDatei =  lvReader.getPropertyString("KundeOriginatorUmstellung", "OutputDatei", "Fehler");
                ...
                new KundeOriginatorUmstellung(lvInstitut, lvImportVerzeichnis, lvExportVerzeichnis, lvKundennummernUmstellungDatei, lvInputDatei, lvOutputDatei);                
            }
        }
