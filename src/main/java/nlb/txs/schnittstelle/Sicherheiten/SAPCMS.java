...
import nlb.txs.schnittstelle.Sicherheiten.Daten.Vorlaufsatz;
...
public class SAPCMS
{
	...
	private void readSAPCMS(String pvDateiname)
	{
	    ...
	    // Oeffnen der Dateien
    	      ...
    	      {
    	        System.out.println("Konnte Sicherheiten-Datei nicht oeffnen!");
    	        return;
    	      }
    	      ...
    	      {
    	        System.out.println("Konnte Sicherheiten-Datei nicht schliessen!");
    	      }
	 ...
	 {	  
      ...
      /**
       * Es wird gepr�ft, ob es zur Kontonummer eine Sicherheit in SAP CMS gibt
       * @param pvKontonummer 
       * @return 
       * 
       */
      ...
      public SicherheitObjekt getSicherheitObjekt(String pvNr)
      {
        ...
        //System.out.println("Suche Sicherheiten SicherheitObjekt zu Kontonummer " + nr);
    ...
    public StringBuffer importSicherheitObjekte(String pvKontonummer, String pvKredittyp, String pvBuergschaftprozent, String pvDeckungskennzeichen) 
    {
        ...
        //helpListe = gwListe.getGeschaeftswerte(nr);
        //System.out.println("Suche Sicherheiten SicherheitObjekt zu Kontonummer " + zielDarlehen.getKontonummer());
