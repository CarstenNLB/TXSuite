...
public class CalendarHelper 
{
    ...
    { 
        ...
        // Christi Himmelfahrt ausschlie�en 
        ...
        // den ersten Mai ausschlie�en 
        lvTemp = new GregorianCalendar(pvYear, 4, 1); 
        lvVec.add(lvTemp); 
        
        // den dritten Oktober ausschlie�en 
        lvTemp = new GregorianCalendar(pvYear, 9, 3); 
        lvVec.add(lvTemp); 
        
        // Weihnachtsfeiertage ausschlie�en 
        ...
        // Silvester und Neujahr ausschlie�en 
