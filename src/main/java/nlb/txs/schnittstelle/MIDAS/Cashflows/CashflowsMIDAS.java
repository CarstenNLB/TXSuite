...
package nlb.txs.schnittstelle.MIDAS.Cashflows;

import nlb.txs.schnittstelle.LoanIQ.Cashflows.CashflowsLoanIQVerarbeitung;
...
public class CashflowsMIDAS 
{
   ...
   { 
       ...
       else
       {
           ...
           new CashflowsLoanIQVerarbeitung(lvReader, CashflowsLoanIQVerarbeitung.MIDAS);
       }
       System.exit(0);
   }
