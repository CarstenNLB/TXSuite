    ...
    private void importDarlehen2Transaktion(Darlehen pvDarlehen)
    {
          ...
          if (lvOkayDarlehen)
          {
              ...
              try
              {
                ...
                ivFosCashflowQuellsystem.write((MappingMIDAS.ermittleMIDASKontonummer(pvDarlehen.getQuellsystem(), pvDarlehen.getKontonummer()) + ";" +
                                                ivFinanzgeschaeft.getKey() + ";" + ivFinanzgeschaeft.getOriginator() + ";" +
                                                ivFinanzgeschaeft.getQuelle() + ";" + lvBuergschaft + ";" + pvDarlehen.getBuergschaftprozent() + ";" +
                		                            ivKondDaten.getMantilg() + ";" + ivKondDaten.getManzins() + ";" + ivKondDaten.getFaellig() +
                                                ";;;;;" + pvDarlehen.getKennzeichenRollover() + ";" + StringKonverter.lineSeparator).getBytes());
              }
              catch (Exception e)
              {
