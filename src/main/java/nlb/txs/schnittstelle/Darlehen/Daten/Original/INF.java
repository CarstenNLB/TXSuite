...
public class INF 
{
    ...
    /**
     * Betrag (Waehrung sh. BWISO)
     */                                         
    private String ivBdmb;
    
    /**
     * Schluessel Ruecklastschrift
     */                                         
    ...
    public String toString() 
    {
        ...
        lvHelpStringBuffer.append("Informationsart/-typ fuer EDR: " + this.ivBbart);
        lvHelpStringBuffer.append(StringKonverter.lineSeparator);
        ...
        lvHelpStringBuffer.append(StringKonverter.lineSeparator);
        lvHelpStringBuffer.append("Betrag (Waehrung sh. BWISO): " + this.ivBdmb);
        lvHelpStringBuffer.append(StringKonverter.lineSeparator);
        lvHelpStringBuffer.append("Schluessel Ruecklastschrift: " + this.ivBrl);
        lvHelpStringBuffer.append(StringKonverter.lineSeparator);
