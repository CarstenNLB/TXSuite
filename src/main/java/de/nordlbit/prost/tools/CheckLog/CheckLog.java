...
package de.nordlbit.prost.tools.CheckLog;
...
public class CheckLog 
{
    ...
    public CheckLog(String pvUsername, String pvPassword, String pvSmtpHost, String pvMailEmpfaenger, String pvLogDatei)
    {
    	...
    	String lvSubject = "TXSuite - Fehler - Bitte Verarbeitung pruefen!";
    ...
    private String existsFatalError(String pvLogDatei)
    {
        ...
        {
          lvText.append("Keine Logdatei '");
          lvText.append(pvLogDatei);
          lvText.append("' vorhanden!");
          lvText.append(StringKonverter.lineSeparator);
        }
        else
        {
          String lvLine = "";
          String lvPreviousLine = "";
          StringBuilder lvErrorText = new StringBuilder();
          ...
          try
          {
            ...
            while ((lvLine = lvBR.readLine()) != null)
            {
            	...
            	if (lvLine.contains("|E|"))
              {
                lvErrorText.append(lvLine + StringKonverter.lineSeparator);
              }

            	// Der Error-Text kann bei Finden einer Info-Zeile geloescht werden.
            	if (lvLine.contains("|I|"))
              {
                lvErrorText = new StringBuilder();
              }

            	// Zeile merken, da sie am Ende benoetigt wird
            	lvPreviousLine = lvLine;
            }
            lvFis.close();
          }
          catch (Exception exp)
          ...
          // Letzte Zeile im Protokoll ist eine Error-Zeile, dann ist die Verarbeitung abgebrochen
          //System.out.println("Previous: " + lvPreviousLine);
          if (lvPreviousLine.contains("|E|"))
          {
            lvText.append(lvErrorText);
          }
        }
