...
public class Aktiv {
    ...
    public Element slicedaten_aktiv(Element pvAktiv, Element pvKey)
    {
        ...
        // element slicedaten f�r die Ausgabe
       ...
       ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
       // Liquidit�tsreserve, setattribute unten !
       String lvMynliqui ="";
       // Ausplatzierungsmerkmal wird verwendet - CT 16.06.2016
       ...
       {
    	   lvMynliqui = "1"; // hier gleichzeitig Liquidt�tsreserve
       }
       else 
       {     
    	   lvMynliqui = "0"; // keine Liquidt�tsreserve
       }
       ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      
       ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
       //// An dieser Stelle die Umsetzung auf die "neuen" Transaktionen/pools Schiffe/Flugzeuge/�PG 
       String lvmytx="";
       String lvmypool="";
       ...
       //     {
       //     	lvmytx = "�ffentlicher Pfandbrief";
       //     	lvmypool = "�ffentlicher Pfandbrief";
       //     }
   ...
   public Element slicedaten_aktiv_old(Element pvAktiv, Element pvKey)
    {
       ...
       if (("S".equals(lvNodeSA01.getChildText("Deckungsschluessel"))) ||
           ...
           ("3".equals(lvNodeSA01.getChildText("Deckungsschluessel"))) ||  // sichernde �D Schiffe
           ...
           ("4".equals(lvNodeSA01.getChildText("Deckungsschluessel"))) ||  // sichernde �D Flugzeuge
           ("8".equals(lvNodeSA01.getChildText("Deckungsschluessel"))) ||  // Liqui Flugzeuge
           ("A".equals(lvNodeSA01.getChildText("Deckungsschluessel"))) ||   // auch f�r die Altdeckung
       ...
       */
       ...
       ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
       // Deckungstyp ermitteln (f�r PfandBG aus dem Suffix, sonst direkt aus dem Deckungskennzeichen
       // setattribute unten !
       String lvMydecktyp = "";
       ...
       {
           lvMydecktyp = "2"; // Sichernde �berdeckung
       }
       ...
       // kommt noch aus MAVIS mit, da PfandBG BLB oder NLB im Namen tr�gt 
       // die "neuen" Projekte tragen das Institut aber nicht im Namen
       ivneuesTxsprojekt = ivTxsprojekt; 
       ...
       // �PG kommt �ber die WPART, hier nur S/U/B
       ...
       {
           // dieses Papier f�r die Sichernde �berdeckung Hypo, projekt muss nicht umgesetzt werden
           ...
           // dieses Papier f�r die weitere Deckung Schiffe, projekt,pool und tx m�ssen nicht umgesetzt werden
           if ("DE000A0B1QY7".equals(pvKey.getChildText("Produkt")))
           {
               lvMydecktyp = "3"; // Weitere Deckung
           }
           // dieses Papier f�r die sichernde Deckung Schiffe, projekt,pool und tx m�ssen nicht umgesetzt werden
           if ("XS0194605506".equals(pvKey.getChildText("Produkt")))
           {
               lvMydecktyp = "2"; // Sichernde �berdeckung
           }
           // Dieses Papier f�r die weitere Deckung Schiffe; projekt, pool und tx muessen nicht umgesetzt werden
           ...
           // dieses Papier f�r die sichernde Deckung �PG
           ...
           // dieses Papier f�r die weitere Deckung Schiffspfandbriefe SU 20140627
           ...
           // dieses Papier f�r die sichernde Deckung �PG hypo / SU 20150309
   ...
   //    el_konddaten.setAttribute("tilgabw","0");
    ...
    public Element kredkunde_aktiv(Element pvAktiv, Element pvKey, String pvBLZ, String pvQuellsystem)
    {
       ...
       // persdaten unter kredkunde h�ngen
