...
/**
 * @author unnasch
 * Erzeugt die TXS Transaktionen f�r Namenspapiere aus Darlehen
 */
@Deprecated
public class PassivDarl {
    ...
    public Element fgdaten_passivdarl(Element pvPassiv, String pvSummenbetrag, String pvQuellsystem)
    {
     ...
     //  el_fgdaten.setAttribute("nbetrag", passiv.getChildText("UrsprungsKapital"));
       ...
       // Sonderbehandlung Uml�ufe OEPG f�r TXS 4.05.450
       if ("PDARLOEPG".equals(pvQuellsystem))
       {
         ...
         // Produkttyp umsetzen
         // der TXS Produkttyp ist den dortigen Aufz�hlungen zu entnehmen
         lvProdukt = pvPassiv.getChildText("ProduktSchluessel");
         
         // -> neue Schl�ssel einpflegen ?
         ...
         // Sonderbehandlung f�r die 'anderen' Register (Schiffe und Flugzeuge)
         ...
         // urlfzmon wird f�r passive Wertpapiere nicht gebraucht
    ...
    {   
      ...
      // Tilgungsrythmus, aus Anzahl der Tilgungen (pro Jahr) und dem Tilgungsschl�ssel ableiten
      // Endf�llig -> Sonderfall
      ...
      // es kommt nur endf�llig in Frage
      lvEl_konddaten.setAttribute("zahltyp","3");
      
      lvEl_konddaten.setAttribute("tilgver","0");
      
      // daher ist die Rate immer das Restkapital
      // aber achtung, f�r schon geradegestellte Positionen wird von Darlehen
      // ein Restkapital von 0 geliefert, daher wird f�r Kontostatus 8 anders 
      // verfahren
      ...
      // Zinsrythmus anhand zweier Felder und f�r zeros Sonderfall
      String lvZinsryth ="";
      ...
      // welche Auspr�gungen aus Darlehen gibt es ??
      if (pvPassiv.getChildText("Zinstyp").equals("F"))
      {
          
       // Aber Achtung, Floater auf EURIBOR usw habe auch ein 'F' sind aber variabel
       // Zeros ebenfalls  
       // und es gibt auch Zeros ohne ZERO, diese werden �ber den Zinsssatz 0 identifiziert   
    ...
    /**
     * F�llen der TXS Transaktion wpposdaten, enth�lt weitere Wertpapierdaten zum Finanzgesch�ft
     * @param pvPassiv 
     * @param pvKorrekturBelieferung 
    ...
    public Element wpposdaten_passivdarl(Element pvPassiv, boolean pvKorrekturBelieferung, boolean pvRestsaldoNull)
    {
      ...
      // aber achtung, f�r schon geradegestellte Positionen wird von Darlehen
      // ein Restkapital von 0 geliefert, daher wird f�r Kontostatus 8 anders verfahren
