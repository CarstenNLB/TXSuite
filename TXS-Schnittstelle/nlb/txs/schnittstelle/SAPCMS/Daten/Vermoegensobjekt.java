...
public class Vermoegensobjekt 
{
   ...
   /**
    * Bemerkung
    * Bemerkung ausländisches Sicherungsrecht nur, wenn COUNTRY <> 'DE'
    */
  ...
  public String toString()
  {
      ...
      lvOut = lvOut + "Eigentümer: " + ivEigentuemer + StringKonverter.lineSeparator;
      ...
      lvOut = lvOut + "Währung des Beleihungswert: " + ivBeleihungswertWaehrung + StringKonverter.lineSeparator;
      lvOut = lvOut + "Verfügungsbetrag: " + ivVerfuegungsbetrag + StringKonverter.lineSeparator;
      lvOut = lvOut + "Währung des Verfügungsbetrag: " + ivVerfuegungsbetragWaehrung + StringKonverter.lineSeparator;
      ...
      lvOut = lvOut + "Währung des Ertragswert: " + ivErtragswertWaehrung + StringKonverter.lineSeparator;
      lvOut = lvOut + "Sachwert: " + ivSachwert + StringKonverter.lineSeparator;
      lvOut = lvOut + "Währung des Sachwerts: " + ivSachwertWaehrung + StringKonverter.lineSeparator;
      ...
      lvOut = lvOut + "Gesamtfläche: " + ivGesamtflaeche + StringKonverter.lineSeparator;
