...
public class SAPCMS2RefiRegister 
{
	/**
	 ...
	 * @param pvSAPCMS
	 */
	public SAPCMS2RefiRegister(SAPCMS_Neu pvSAPCMS)
	{
    ...
    public StringBuffer import2TXSKreditSicherheit(Sicherungsumfang pvShum, String pvKontonummer, String pvPassivkontonummer, String pvKundennummer, String pvKredittyp, String pvBuergschaftprozent, String pvQuellsystem) 
    {
        ...
        System.out.println("import2TXSKreditSicherheit");
        ...
        { 
            ...
            if (lvHelpLast.getSicherheitenvereinbarungId().equals(lvSicherheitenvereinbarung.getId()))
            {
             ...
             if (lvLast != null)
             {
                 ...
                 System.out.println("TXSKreditSicherheit - Start");
             
                 lvSh = new TXSSicherheit();
                 lvSh.setKey(lvSicherheitenvereinbarung.getSicherheitenvereinbarungsId());
                 lvSh.setOrg(ValueMapping.changeMandant(ivSAPCMS.getVorlaufsatz().getInstitut()));
                 ...
                 lvHelpPerson.setOrg(ValueMapping.changeMandant(ivSAPCMS.getVorlaufsatz().getInstitut()));
                 ...
                 while (lvIteratorGrundbuchblatt.hasNext())
                 {
                     ...
                     if (lvGrundbuchverweis == null)
                     {
                         ivSAPCMS.getLogger().error("Konnte keinen Grundbuchverweis fuer Last " + lvLast.getId() + " und Grundbuchblatt " + lvGrundbuchblatt.getId() + " ermitteln!");
                     ...
                     if (ivSAPCMS.getVorlaufsatz().getInstitut().equals("009"))
                     {
                         if (lvVerweisVorhanden && lvGrundbuchverweis != null)
                         {
                             ivSAPCMS.getLogger().info("TXSSicherheitVerzeichnis Venr;" + lvImmobilie.getObjektId() + lvGrundbuchblatt.getBand() + lvGrundbuchblatt.getBlatt() + lvGrundbuchverweis.getLaufendeNrAbt3() + ";" + lvGrundbuchverweis.getId());                     
                         }
                     ...
                     if (lvVerweisVorhanden && lvGrundbuchverweis != null)
                     {
                         ...
                         ivSAPCMS.getLogger().info("NrAbt3" + ";" + pvKontonummer + ";" + lvSicherheitenvereinbarung.getSicherheitenvereinbarungsId() + ";"  + lvLast.getRegisternummer() + ";" + lvGrundbuchverweis.getLaufendeNrAbt3());
                     }
                     else
                     {
                     ...
                     if (lvSicherheitenvereinbarung.getGesamtgrundschuldKennzeichen().equals("X"))
                     {
                         if (lvCollectionGrundbuchblatt.size() > 1)
                         {
                             ...
                             if (lvAnzahlGrundbuchblaetter == 0)
                             {
                            	...
                            	ivSAPCMS.getLogger().info("Keine passenden Grundbuchverweise gepflegt: " + lvSicherheitenvereinbarung.getSicherheitenvereinbarungsId());
                             }
                             ...
                             if (lvVerweisVorhanden && lvGrundbuchverweis != null)
                             {
                                 ivSAPCMS.getLogger().info("ZuweisungsbetragPO;" + lvImmobilie.getObjektId() + lvGrundbuchblatt.getBand() + lvGrundbuchblatt.getBlatt() + lvGrundbuchverweis.getLaufendeNrAbt3() + ";" + lvHelpBetrag.toString());                     
                     
                             }
                             else
                             {
                                 ivSAPCMS.getLogger().info("ZuweisungsbetragPO;" + lvImmobilie.getObjektId() + lvGrundbuchblatt.getBand() + lvGrundbuchblatt.getBlatt() + lvLast.getRegisternummer() + ";" + lvHelpBetrag.toString());                     
                             }
                     ...
                     if (ivSAPCMS.getVorlaufsatz().getInstitut().equals("009"))
                     {
                         if (lvVerweisVorhanden && lvGrundbuchverweis != null)
                         {
                             ivSAPCMS.getLogger().info("TXSVerzeichnisVBlatt Vbnr;" + lvImmobilie.getObjektId() + lvGrundbuchblatt.getBand() + lvGrundbuchblatt.getBlatt() + lvGrundbuchverweis.getLaufendeNrAbt3() + ";" + lvGrundbuchverweis.getId());                            
                         }
                     }
                     ...
                     while (lvIteratorGrundstueck.hasNext())
                     {
                         ...
                         if (lvGrundstueck.getGrundbuchblattId().equals(lvGrundbuchblatt.getId()))
                         {
                             ...
                             if (ivSAPCMS.getVorlaufsatz().getInstitut().equals("009"))
                             {
                                 if (lvVerweisVorhanden && lvGrundbuchverweis != null)
                                 {
                                     ivSAPCMS.getLogger().info("TXSVerzeichnisBestandsverz Bvnr;" + lvImmobilie.getObjektId() + lvGrundbuchblatt.getBand() + lvGrundbuchblatt.getBlatt() + lvGrundbuchverweis.getLaufendeNrAbt3()
                                                                + lvGrundstueck.getLaufendeNummer() + ";" + lvGrundstueck.getId());

                                 }
                                 else
                                 {
                                     ivSAPCMS.getLogger().info("TXSVerzeichnisBestandsverz Bvnr;" + lvImmobilie.getObjektId() + lvGrundbuchblatt.getBand() + lvGrundbuchblatt.getBlatt() + lvLast.getRegisternummer()
                                                                + lvGrundstueck.getLaufendeNummer() + ";" + lvGrundstueck.getId());
                                 }
                             }
    ...
    {
        StringBuffer lvHelpString = new StringBuffer(); 
        ivSAPCMS.getLogger().info("RefiRegister: import2TXSKreditSicherheitSchiffe");
        TXSKreditSicherheit lvKredsh = null;
        TXSSicherheitDaten lvShdaten = null;
        TXSSicherheitVerzeichnis lvShve = null;
        TXSVerzeichnisDaten lvVedaten = null;
        ...
        while (lvIteratorLast.hasNext())
        {
            ...
            if (lvHelpLast.getSicherheitenvereinbarungId().equals(lvSicherheitenvereinbarung.getId()))
            {
             ...
             if (lvLast != null)
             {
                 ...
                 {
                	 ivSAPCMS.getLogger().error("Kein Schiff vorhanden;" + pvKontonummer + ";" + lvSicherheitenvereinbarung.getId()); 
                 }
                 ...
                 lvShdaten.setWhrg("EUR");
                 
                 //System.out.println("Anzahl RefiDeepSeaZusatz: " + pvListeRefiDeepSeaZusatz.size());
                 //System.out.println("get: " + pvKontonummer + lvSchiff.getSchiffId()); //lvSicherheitenId);
                 RefiDeepSeaZusatz lvRefiDeepSeaZusatz = pvListeRefiDeepSeaZusatz.get(pvKontonummer + lvSchiff.getSchiffId()); // + lvSicherheitenId);
                 if (lvRefiDeepSeaZusatz != null)
                 {
                 	...
                 	//lvShdaten.setReginfo(String2XML.change2XML(lvRefiDeepSeaZusatz.getSchiffsregister()));
                 }
