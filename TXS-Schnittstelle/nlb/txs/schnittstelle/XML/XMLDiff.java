...
public class XMLDiff 
{
    ...
    public void openConnection()
    {
        ...
        {
            System.err.println("Konnte keine Datenbankverbindung zu " + svIP + ":" + svPort + "/" + svDatenbank + " herstellen.");
        }
    }
    ...
    public void insert(String pvKey, String pvTransaktion, String pvAttribute, String pvValue)
    {
    	...
    	{
    		System.out.println("Konnte Monitoring-Datensatz nicht einfuegen.");
    	}  
    }
