...
public class ValueMapping 
{
    ...
    public static String changeKundengruppe(String pvText)
    {
        ...
        // A_3 Ausl., Regionalreg./�ff. Geb.-k�rpersch.
        // B_1 Bund
        // B_2 Andere durch Bund abgesichert
        // C   Bundesl�nder
        // D   St�dte, Gemeinden, Kreise, Bezirke
        // E   �ffentliche Unternehmen, Zweckverb�nde
        // G   Kreditinstitute
        // H   sonst. kommunale GP
        // F   Unternehmen von St�dten Gemeinden und Kommunen
        // A_4 Andere ausl. St�dte und Gemeinden
        // A_5 Andere ausl. Regionen Provinzen und Staaten
        // A_6 Andere ausl. staatliche oder �ffentliche Unternehmen
        // -1  undefiniert
        ...
        {
            pvText = "Ausl., Regionalreg./�ff. Geb.-k�rpersch.";
            lvGefunden = true;
        }
        ...
        if (pvText.equals("D"))
        {
            pvText = "St�dte, Gemeinden, Kreise, Bezirke";
            lvGefunden = true;
        }
        if (pvText.equals("E"))
        {
            pvText = "�ffentliche Unternehmen, Zweckverb�nde";
            lvGefunden = true;
        }
        if (pvText.equals("G"))
        {
        ...
        if (pvText.equals("F"))
        {
            pvText = "Unternehmen von St�dten Gemeinden und Kommunen";
            lvGefunden = true;
        }
        if (pvText.equals("A_4"))
        {
            pvText = "Andere ausl. St�dte und Gemeinden";
            lvGefunden = true;
        }
        ...
        {
            pvText = "Andere ausl. staatliche oder �ffentliche Unternehmen";
            lvGefunden = true;
        }
        if (!lvGefunden)
            System.out.println("Unbekannte Kundengruppe: " + pvText);

        // Die L�nge der Kundengruppe darf maximal 40 Zeichen sein
        if (pvText.length() > 39)
        {
    ...
    public static String mapNutzungsartDarlehen(String pvObjektart)
    {
      ...
      // TXS 5 - Sonstige Grundst�cke - Objektart x60             
    ...
    {
      // TXS 9 - Wohnwirtschaftlich genutztes Grundst�ck - Objektart x10
      // TXS 1 - Einfamilienhaus - Objektart x16
      // TXS 4 - Mehrfamilienhaus - Objektart x12
      // TXS 5 - Wohnung - Objektart x17
      // TXS 9 - Wohnwirtschaftlich genutztes Grundst�ck - Objektart x14
      // TXS 9 - Wohnwirtschaftlich genutztes Grundst�ck - Objektart x15
      // TXS 58 - Landwirtschaftlich genutztes Grundst�ck - Objektart x2, x3, x4
      // TXS 57 - Gewerblich genutztes Grundst�ck - Objektart x50
      ...
      // TXS 21 - Handelsgeb�ude - Objektart x54
      // TXS 31 - Hotel / Gastst�tte - Objektart x55
      // TXS 42 - B�rogeb�ude - Objektart x56
      // TXS 15 - Industriegeb�ude - Objektart x57
      // TXS 15 - Industriegeb�ude - Objektart x58
      // TXS 13 - Sonstiges gewerblich genutztes Geb�ude - Objektart x59
      // TXS 57 - Gewerblich genutztes Grundst�ck - Objektart x60
      // TXS 57 - Gewerblich genutztes Grundst�ck - Objektart x61
      // TXS 38 - Sportanlage / Freizeitanlage - Objektart x62
      // TXS 52 - Lagerhalle / Warenlagergeb�ude / K�hlhaus - Objektart x63
      ...
      // TXS 52 - Lagerhalle / Warenlagergeb�ude / K�hlhaus - Objektart x67
      // TXS 15 - Industriegeb�ude - Objektart x68
    ...
    {
        // EDR
        // 010 Wohnungsgrundst�cke ohne spezielle Definition                 
        // 011  Ein- und Zweifamilienh�user                                   
        // 012  Mehrfamilienh�user (inkl. Mietwohnanlagen ab 3 Wohneinheiten) 
        // 013  Eigentumswohnungen (sowohl Eigen- als auch Fremdnutzung)      
        // 014  Sonstige Wohngrundst�cke                                      
        // 015  gemischte Nutzung mit mehr als 50% Wohnungsbau                
        // 020  Landwirtschaftliche Grundst�cke                               
        // 050  Gewerbliche Baupl�tze                                         
        // 051  Kliniken (z.B. Krankenh�user, Rehakliniken)                   
        // 052  Kurheime / Sanatorien                                         
        // 053  Pflegeheime                                                   
        // 054  Einkaufszentren / SB-M�rkte / Kaufh�user                      
        // 055  Hotels und Gastst�tten (inkl. Fremdenheime/Pensionen/Kantinen)
        // 056  B�ro- und Verwaltungsgeb�ude (inkl. Kanzleigeb�ude)           
        // 057  Produktionsst�tten / Fabriken / Druckereien                   
        // 058  Brauereien                                                    
        // 059  Einrichtungen der Infrastruktur und Forschung                 
        // 060  Sonstige Grundst�cke / Kommunalkredite                        
        // 061  gemischte Nutzung mit mehr als 50% gewerblich                 
        // 062  Sportanlagen / Freizeitanlagen                                
        // 063  Lagerhallen/Warenlagergeb�ude/Tankstellengeb./K�hlh�user      
        // 064  Arztpraxen (inkl. medizinische Behandlungsinstitute, ambulante
        // 065  Parkh�user / Tiefgaragen / Waschhallen                        
        // 066  Werkst�tten / Hobelwerke                                      
        // 067  Vergn�gungs- und Unterhaltungsst�tten                         
        // 068  Windkraftanlagen                                              
        // 094  unbekannt                                                     

        // TXS
        // 9  Wohnwirtschaftlich genutztes Grundst�ck
        // 1   Einfamilienhaus
        // 4   Mehrfamilienhaus
        // 5   Wohnung
        // 9   Wohnwirtschaftlich genutztes Grundst�ck
        // 9   Wohnwirtschaftlich genutztes Grundst�ck
        // 58  Landwirtschaftlich genutztes Grundst�ck
        // 57  Gewerblich genutztes Grundst�ck
        // 33  Klinik
        // 36  Kurheim 
        // 34  Pflegeheim
        // 13  Sonstiges gewerblich genutztes Geb�ude
        // 31  Hotel / Gastst�tte
        // 42  B�rogeb�ude
        // 15  Industriegeb�ude
        // 15  Industriegeb�ude
    ...
    public static int PLZ2Land(String pvInst, String pvPLZ)
    {
     ...
     { /* PLZ ist da */
      ...
      { /* PLZ 7* */
                lvRetwert2 = 8; /* Baden-W�rtenberg default */
  ...
  /**
     * @param pvLandnum dreistelliger numerischer Code gem�� Aussenwirtschaftsstatistik
     * @return zweistelliger L�ndercode gem�� ISO
     * @author Unnasch
     */
     ...
     * @return Referenzzins gem�� TXS-Enum Referenzzins
     * @author Unnasch
     */
