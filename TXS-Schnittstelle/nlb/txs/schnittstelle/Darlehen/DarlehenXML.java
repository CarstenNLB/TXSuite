...
public class DarlehenXML 
{
     ...
     * @param mandant 
     */
    public DarlehenXML(String pvFilename)
    {
    ...
    public void openXML()
    {
      ...
      {
        System.out.println("Konnte Darlehen XML-Datei nicht oeffnen!");
      }    
    }
    ...
    public void closeXML()
    {
      ...
      {
          System.out.println("Konnte Darlehen XML-Datei nicht schliessen!");       
      }
    }
    ...
    {   
      ...
      {
        System.out.println("Start: Fehler bei Ausgabe in Darlehen XML-Datei");
      }
    }
    ...
    public void printDarlehen(Darlehen pvDarlehen)
    {
        ...
        try
        {
           ivXmlOS.write((new String("  <Darlehen nr=\"" + pvDarlehen.getKontonummer() + "\" >" + StringKonverter.lineSeparator)).getBytes());          
           ...
           {
             ivXmlOS.write((new String("    <Selektionskennzeichen></Selektionskennzeichen>" + StringKonverter.lineSeparator)).getBytes());
           }
           else
           {
               ivXmlOS.write((new String("    <Selektionskennzeichen>" + pvDarlehen.getSelektionskennzeichen() + "</Selektionskennzeichen>" + StringKonverter.lineSeparator)).getBytes());               
           }
           ...
           ivXmlOS.write((new String("  </Darlehen>" + StringKonverter.lineSeparator)).getBytes());           
        }
        catch (Exception e)
        {
          System.out.println("Start: Fehler bei Ausgabe in Darlehen XML-Datei");
