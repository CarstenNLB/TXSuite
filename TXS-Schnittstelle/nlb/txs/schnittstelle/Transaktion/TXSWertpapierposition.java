...
{
    /**
     * Abweichende F�lligkeit (Sonderf�lligkeit)
     * Optional
     */
    ...
    /**
     * "Saldo. Ein Originator liefert normalerweise durchg�ngig 
    ...
    /**
     * "W�hrung der gemeldeten Betr�ge dieser Transaktion.
     * (Definition gem�� ISO-Standard)"
     * Pflicht nur bei Angabe von Betragswerten
     */
    private String ivWhrg;

    /**
     * "Eindeutiger Schl�ssel (in allen Systemen verwendet).
     * Jede WP-Position muss einen eigenen, eindeutigen Schl�ssel besitzen. Es darf hier nicht der Schl�ssel des zugeh�rigen Wertpapiers angegeben werden.
     * z.B.: 1234567890 "
     * Pflicht
     */
