...
public class TXSPfandobjektDaten implements TXSTransaktion
{
    ...
    /**
     * Containerkapazit�t. Nur relevant f�r Pfandobjekte der Kategorie "Schiff"
     */
    ...
    /**
     * Datum der Fertigstellung des Pfandobjekts. Nur relevant f�r Pfandobjekte der Kategorien "Schiff" und "Flugzeug"
     */
    ...
    public void importDarlehen(Darlehen darlehen, Sicherungsobjekt pvObj) 
    {
        ...
        { /* Es ist etwas da .... */
         ...
         { /* nichts da .... */
          lvStaat = "100";
          /* Gebiet �ber PLZ */
          /* Hier ist die PLZ f�r das Land interessant */
          int lvRetGebiet = -1;
          ...
          /* Die f�hrende 100 f�hrt zum Ergebnis "undefiniert" ...*/
          /* Vielleicht wird es sp�ter wieder so ....             */
          if (lvRetGebiet == -1)
          {
           lvLand = "undefiniert";
          }
         ...
         // { /* Nicht Sonderfall 1 + 2 */
           ...
           /* Ein-/Zweifamilienh�user 016 -> 011 */
