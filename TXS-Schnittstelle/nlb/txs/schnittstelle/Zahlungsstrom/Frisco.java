 ...
 *
 * Dieses Programm verarbeitet XML-Zahlungstr�me aus der Anwendung FRSICO (via hostprogramm CEDRCF01),
 * fasst diese ggf. zusammen und gibt eine 
 * XML-Datei im XML-Format f�r die Anwendung TXS aus 
 *
...
public class Frisco {
    ...
    {    
       ...
       //   System.out.println("listing " + listing[n]); 
          ...
          {
            //  System.out.println("Dateiname k�rzer als A1PBAT.NT.I009.LMTXS.KSXML");   
          }
        }
        
        LOGGER.info("Datei mit h�chstem daypointer " + lvNeuedatei);
        ...
        {
            LOGGER.error("�rger mit dem bufferedreader");
        }
   ...
   //       Element ablaufelem3;
          ...
          // Schleife �ber das document - erst alle aktiven Papiere
          ...
          //    System.out.println(i + "*** Konto= " + stammelem.getAttributeValue("nr") + " " + stammelem.getAttributeValue("ap"));
              ...
              {
                lvElement_fg.setAttribute("quelle","DARLEHEN");     // Fremdw�hrungsdarlehen  
          ...
          //    ablauflist.clear();
              ...
              // jetzt Test auf ein auf zwei hostzeilen gesplittetes Konto, n�chstes Element holen
              ...
              if (i<lvKontolist.size()-1)
              {
                ...
                if (lvStammelem.getAttributeValue("nr").equals(lvStammelem3.getAttributeValue("nr")))
                {
                  ...
                  {
                      Element lvMyelem = (Element) lvAblauflistzweizeiler.get(0); // detach sorgt f�r das vorr�cken
                 ...
                 // Treffer: gro�en Kontenz�hler einen vorr�cken
                    i++;
              ...
              // Einmal �ber alle Ablaufelemente
          ...
          // Schleife �ber die kleinere Liste mit den passiven
          for (int m=0; m< lvKontolistP.size(); m++)
          {
              ...
              */
              ...
              // Andere Behandlung f�r BLB, dort ist die ISIN nie gef�llt und
              ...
              // aber *zun�chst* so nicht an TXS weitergegeben, daher auf leer
              ...
              {
                lvElement_fg.setAttribute("quelle","DARLEHENWP");     // Fremdw�hrungsdarlehen  
              }
              else if ("98".equals(lvStammelem.getAttributeValue("anw")))
              {
                lvElement_fg.setAttribute("quelle","DARLEHEN");     // "ausgeblendete"  
              ...
              for (int n=m+1; n< lvKontolistP.size(); n++)
              {
                ...
                if (lvIsin2.equals(lvIsin1) && !lvIsin2.equals(""))
                {
                  ...
                  {
                      Element lvMyelem = (Element) lvAblauflistplus.get(0); // detach sorgt f�r das vorr�cken
                 ...
                 for (int k=j+1; k<lvAblauflist.size(); k++)
                 {
                     ...
                     if (lvDatum1.equals(lvDatum2))
                     {
                         ...
                         if ( ("11".equals(lvAblaufelem2.getAttributeValue("art"))) ||   // tilgung
                              ("12".equals(lvAblaufelem2.getAttributeValue("art"))) ||   // au�erplanm��ige Tilgung
                              ...
                              ("17".equals(lvAblaufelem2.getAttributeValue("art")))    ) // RK zum K�ndigungstermin
                         {
                            lvBufferbd = BigDecimal.valueOf(Double.parseDouble(lvAblaufelem2.getAttributeValue("betr")));  
                            lvTbetragbd = lvTbetragbd.add(lvBufferbd);  
              ...
              //   element_cfdaten_last.setAttribute("zbetrag",Double.toString(zbetrag));
                 ...
                 // KEINE TILGUNGEN F�R PASSIVE 20121219   
