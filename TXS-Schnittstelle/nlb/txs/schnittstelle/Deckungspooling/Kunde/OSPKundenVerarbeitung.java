...
public class OSPKundenVerarbeitung 
{
    ...
    {        
        ...
        for (int i = 0; i < lvListInst.size(); i++)
        {
            ...
            if (ivListeQuellsysteme.containsKey(lvRegKz + lvOSPInst))
            {
                ...
                // Die Statistik muss noch �berarbeitet werden, da jetzt immer
    ...
    /**
     * Ermittlung der Kundengruppe �ber die Kusyma 
     * @param pvKusyma
     * @return
     */
    private String ermittleKundengruppe(String pvKusyma)
    {
        ...
        { /* Inl�ndische Kreditinstitute */
            lvKGruppe = "G";
        } /* Inl�ndische Kreditinstitute */
        if (pvKusyma.startsWith("1"))
        { /* Inl�ndische �ffentliche Haushalte */
            ...
            { /* Nicht direkt Bund */
                ...
                { /* keine Bundesl�nder */
                    ...
                    { /* keine Gemeinden */
                        ...
                        { /* �fftl.Untern/Zweck. */
                            lvKGruppe = "E";
                        } /* �fftl.Unternehmen/Zweckverb�nde */
                        else
                        { /* Keine �fftl.Unternehmen/Zweckverb�nde */
        ...
        { /* Ausl�ndische �ffentliche Haushalte */
