...
public class Geschaeftswert 
{
    ...
    */
    ...
    /**
     * W�hrung des Zuweisungsbetrag
     */
    private String ivZuweisungsbetragWaehrung;
    
    /**
     * Einschr�nkung f�r Teil
     */
    ...
    public String toString()
    {
        ...
        lvOut = lvOut + "Gesch�ftswert-ID: " + ivGeschaeftswertID + StringKonverter.lineSeparator;
        ...
        lvOut = lvOut + "W�hrung des Zuweisungsbetrag: " + ivZuweisungsbetragWaehrung + StringKonverter.lineSeparator;
        lvOut = lvOut + "Einschr�nkung f�r Teil: " + ivEinschraenkungTeil + StringKonverter.lineSeparator;
        ...
        lvOut = lvOut + "W�hrung des Teilwerts: " + ivTeilwertWaehrung + StringKonverter.lineSeparator;
