...
public class Sicherheitenvereinbarung 
{
    ...
    /**
     * W�hrung des anzusetzenden Wertes
     */
    ...
    public String toString()
    {
        ...
        lvOut = lvOut + "G�ltig von: " + ivGueltigVon + StringKonverter.lineSeparator;
        lvOut = lvOut + "G�ltig bis: " + ivGueltigBis + StringKonverter.lineSeparator;
        ...
        lvOut = lvOut + "W�hrung des anzusetzenden Wertes: " + ivAnzusetzenderWertWaehrung + StringKonverter.lineSeparator;
        lvOut = lvOut + "Verf�gungsbetrag: " + ivVerfuegungsbetrag + StringKonverter.lineSeparator;
        lvOut = lvOut + "W�hrung des Verf�gungsbetrags: " + ivVerfuegungsbetragWaehrung + StringKonverter.lineSeparator;
