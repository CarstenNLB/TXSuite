...
public class Sicherheiten2Pfandbrief implements Sicherheiten2Register
{
  ...
  private SicherheitenDaten ivSicherheitenDaten;
     ...
     * @return
     */
    public StringBuffer importSicherheitBuergschaft(String pvKontonummer, String pvQuellsystem, String pvRestkapital, String pvBuergschaftprozent, String pvAusplatzierungsmerkmal, String pvNominalbetrag, String pvKundennummer, String pvBuergennummer)
    {
        StringBuffer lvBuffer = new StringBuffer();
        ...
        if (lvHelpListe != null)
        {
            for (int x = 0; x < lvHelpListe.size(); x++)
            {
                ...
                //this.getLogger().info("Start...");
                  lvBuffer.append(this.import2TXSKreditSicherheitBuerge(lvShum, pvKontonummer, pvQuellsystem, pvRestkapital, pvBuergschaftprozent, pvAusplatzierungsmerkmal, pvNominalbetrag, pvKundennummer, pvBuergennummer));
                 ...
                 while (lvIteratorGrundbuchblatt.hasNext())
                 {
                     ...
                     { // Es ist etwas da .... 
                        ...
                        //String lvErtragsKz = "3";
                         ...
                         lvPodaten.setEigtyp(ValueMapping.mapEigentumstypSPOT(lvImmobilie.getNutzung()));
        ...
        while (lvIteratorLast.hasNext())
        {
            ...
            if (lvHelpLast.getSicherheitenvereinbarungId().equals(lvSicherheitenvereinbarung.getId()))
            {
             ...
             if (lvLast != null)
             {
                 ...
                 lvPodaten.setSbrnr(lvSchiff.getSchiffstypen());

                 // CT 08.04.2020 - SAP CMS - SPOT setzeSchiffsdaten(lvSchiff.getSchiffstypen().substring(1), lvPodaten);
                 setzeSchiffsdaten(lvSchiff.getSchiffstypen(), lvPodaten);
     ...
     */
    public StringBuffer import2TXSKreditSicherheitBuerge(Sicherungsumfang pvShum, String pvKontonummer, String pvQuellsystem, String pvRestkapital, String pvBuergschaftprozent, String pvAusplatzierungsmerkmal, String pvNominalbetrag, String pvKundennummer, String pvBuergennummer)
    {
        StringBuffer lvHelpString = new StringBuffer(); 
            ...
            while (lvIteratorGeschaeftspartner.hasNext())
            {
                ...
                if (lvGeschaeftspartner != null)
                {
                	...
                	if (lvGeschaeftspartner.getGeschaeftspartnerfunktion().equals("050002"))
                	{
                        ...
                        lvShperson.setOrg(ValueMapping.changeMandant(ivSicherheitenDaten.getVorlaufsatz().getInstitut()));
