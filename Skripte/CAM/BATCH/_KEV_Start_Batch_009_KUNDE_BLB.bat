...
REM Kunde starten
call KundeKEV_BLB.bat

copy /Y F:\CAM_009_PROD\DATEN\LB\KEV_Kunde_BLB_TXS.xml F:\CAM_009_PROD\Import\KEV_Kunde_BLB_TXS.xml
...
FOR /F "tokens=1-4 delims= " %%A in (F:\CAM_009_PROD\STATUS\LB\Prost_KUNDE_BLB.txt) do (
