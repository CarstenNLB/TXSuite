...
call DarKaKEV_BLB.bat

REM Importdatei kopieren
copy F:\CAM_009_PROD\DATEN\LB\KEV_DarKa_BLB_TXS.xml F:\CAM_009_PROD\IMPORT\KEV_DarKa_BLB_TXS.xml
...
FOR /F "tokens=1-4 delims= " %%A in (F:\CAM_009_PROD\STATUS\LB\Prost_DARLEHEN_BLB.txt) do (
