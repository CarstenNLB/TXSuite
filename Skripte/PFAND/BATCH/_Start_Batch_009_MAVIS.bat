...
xcopy /y W:\A1PBAT.BM.I009.DPMAVIS.M710X.XMLOUT.D%Host-Date-Suffix% F:\TXS_009_TRANSFER\MAVIS\IMPORT\

del /q W:\A1PBAT.BM.I009.DPMAVIS.M710X.XMLOUT.D%Host-Date-Suffix%
...
powershell F:\TXS_009_PROD\PROGRAMM\LB\mavis_xml_korrektur.ps1

REM eigentliche MAVIS Verarbeitung
call MAVIS.bat

REM Archivieren
cd F:\TXS_009_TRANSFER\MAVIS\IMPORT
xcopy /y A1PBAT.BM.I009.DPMAVIS.M710X.XMLOUT.D%Host-Date% F:\TXS_009_PROD\DATEN\LB\A1PBAT.BM.I009.DPMAVIS.M710X.XMLOUT
zip -m F:\TXS_009_TRANSFER\MAVIS\IMPORT\%Date-Suffix%.zip A1PBAT.BM.I009.DPMAVIS.M710X.XMLOUT.D%Host-Date-Suffix%
