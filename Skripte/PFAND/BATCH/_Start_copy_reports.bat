...
net use Y: \\kbk.NordLB.local\Dbe\107920\107241 <###pwd###> /USER:KBK\TXSTRV01

copy ReportTXS_009_%date:~6,4%%date:~3,2%%date:~0,2%.zip Y:\"3 TXS-Reports"
copy ReportTXS_009_taeglich.zip Y:"\3 TXS-Reports\ReportTXS_009_%date:~6,4%%date:~3,2%%date:~0,2%_taeglich.zip"
...
rem PROST bedienen
FOR /F "tokens=1-4 delims= " %%A in (F:\TXS_009_PROD\STATUS\LB\Prost_Versende_Reports_an_Fachbereich.txt) do (
